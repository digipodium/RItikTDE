                        ...
                        FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(otp_verfication.this, "Enter the correct otp", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });

                    } else {
                        Toast.makeText(otp_verfication.this, "Please check internet connection", Toast.LENGTH_SHORT).show();
                    }


                    //   Toast.makeText(enterOTP.this, "OTP verify", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(otp_verfication.this, "Please Enter all number", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        resendlabel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        "+91" + getIntent().toString(), 60, TimeUnit.SECONDS, otp_verfication.this,
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(otp_verfication.this, "OTP sended successfully", Toast.LENGTH_SHORT).show();
