    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drivers.put("did", fAuth.getCurrentUser().getUid());
                drivers.put("dphonenumber", fAuth.getCurrentUser().getPhoneNumber());
                db.collection("drivers")
                        .document(fAuth.getCurrentUser().getUid())
                        .set(drivers)
                        .addOnSuccessListener(unused -> {
                            Intent intent = new Intent(getApplicationContext(), DriverId.class);
                            startActivity(intent);
                        })
                        .addOnFailureListener(e -> Log.w(TAG1, "Error adding document", e));
            }
        });
    }
