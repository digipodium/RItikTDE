                    ...
                    if (enternumber.getText().toString().trim().length() == 10) {
                        ...
                        PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                progressBar.setVisibility(View.GONE);
                                getotpbutton.setVisibility(View.VISIBLE);
                                Toast.makeText(Activity4.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        ...
                        PhoneAuthOptions options =
                                PhoneAuthOptions.newBuilder(auth)
                                        ...
                                        .setActivity(Activity4.this)                 // Activity (for callback binding)
                        ...
                        Toast.makeText(Activity4.this, "please enter the correct number", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(Activity4.this, "Enter mobile number", Toast.LENGTH_SHORT).show();
                }
